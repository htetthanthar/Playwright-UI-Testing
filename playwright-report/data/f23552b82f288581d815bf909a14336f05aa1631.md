...
- Name: shopping-flow.spec.ts >> Task 2: Product and Cart Validation >> should add two products to cart and verify badge count
- Location: tests\shopping-flow.spec.ts:134:7
